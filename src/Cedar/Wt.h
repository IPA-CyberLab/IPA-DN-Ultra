...
#define WT_SPECIALOPCODE_C2S_SWITCHTOWEBSOCKET_REQUEST		16777001
...
struct SOCKIO
{
	...
	BUF *SendBuf;						// 送信バッファ
	UINT UserData1, UserData2, UserData3, UserData4, UserData5, UserData6, UserData7, UserData8;	// ユーザーデータ
	UINT64 ServerMask64;
