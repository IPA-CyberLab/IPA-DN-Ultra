...
typedef struct DC_NWDETECT_SETTINGS DC_NWDETECT_SETTINGS;
typedef struct DC_NWDETECT DC_NWDETECT;
typedef struct DC_NWDETECT_THREADPARAM DC_NWDETECT_THREADPARAM;
typedef void (DC_NWDETECT_CALLBACK)(DC_NWDETECT* t);
typedef struct DC_NWDETECT_RESULT DC_NWDETECT_RESULT;
