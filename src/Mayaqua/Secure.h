...
SECURE_DEVICE SupportedList[] =
{
	...
	{24,	SECURE_IC_CARD,		"JPKI IC Card (64bit)",			"Japanese Government",	"JPKIPKCS1164.DLL"},
	{25,	SECURE_IC_CARD,		"OpenSC Smart Card",	"OpenSC",	"opensc-pkcs11.dll"},
	{26,	SECURE_IC_CARD,		"My Number Card",	"Japanese Government",	"JPKIPKCS11Auth.dll"},
	{27,	SECURE_IC_CARD,		"My Number Card (64bit)",	"Japanese Government",	"JPKIPKCS11Auth64.dll"},
};
